...
module RecordingStudioPublishable
  ...
  #   RecordingStudioPublishable.configuration.hooks.after_initialize do
  #     Rails.logger.info "RecordingStudioPublishable initialized!"
  #   end
  #
  ...
  class Hooks
    ...
    def log_hook_error(error, event_name, _hook)
      ...
      Rails.logger.error "[RecordingStudioPublishable::Hooks] Error in #{event_name} hook: #{error.message}"
    ...
    class << self
      ...
      # @return [Array] Results from all hooks
      def run(event_name, *)
        RecordingStudioPublishable.configuration.hooks.run(event_name, *)
      end
      ...
      def run_around(event_name, context, &)
        RecordingStudioPublishable.configuration.hooks.run_around(event_name, context, &)
      end
