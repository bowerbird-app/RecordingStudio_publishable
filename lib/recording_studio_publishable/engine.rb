...
module RecordingStudioPublishable
  class Engine < ::Rails::Engine
    ...
    initializer "recording_studio_publishable.before_initialize", before: "recording_studio_publishable.load_config" do |_app|
    ...
    initializer "recording_studio_publishable.load_config" do |app|
      if app.respond_to?(:config_for)
        yaml = app.config_for(:recording_studio_publishable) rescue nil
    ...
    initializer "recording_studio_publishable.after_initialize", after: "recording_studio_publishable.load_config" do |_app|
    ...
    def register_publishable_recordable_type
      ...
      recordable_types = Array(RecordingStudio.configuration.recordable_types).map do |recordable_type|
